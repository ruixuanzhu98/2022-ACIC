...
write.csv(df_record,"/Users/piglet/Desktop/track2_20220404/nops_f(x)_record.csv",row.names = FALSE)   
...
for (i in 1:3400){
  ...
  df=read.csv(path)
  df_record=read.csv("/Users/piglet/Desktop/track2_20220404/nops_f(x)_record.csv")
  ...
  for (j in 1:1000){
      ...
      y1_posterior_year3=fx_posterior_1_year3[j,]
      y0_posterior_year3=fx_posterior_0_year3[j,]
      y1_posterior_year4=fx_posterior_1_year4[j,]
      y0_posterior_year4=fx_posterior_0_year4[j,]
      satt_year3[j]=sum((y1_posterior_year3-y0_posterior_year3)*df_year3$n.patients)/N_3
      satt_year4[j]=sum((y1_posterior_year4-y0_posterior_year4)*df_year4$n.patients)/N_4
      satt_overall[j]=(satt_year3[j]*N_3+satt_year4[j]*N_4)/(N_3+N_4)
      satt_X1_0[j]=(sum((y1_posterior_year3[df_year3$X1==0]-y0_posterior_year3[df_year3$X1==0])*df_year3$n.patients[df_year3$X1==0])+
      ...
      satt_X1_1[j]=(sum((y1_posterior_year3[df_year3$X1==1]-y0_posterior_year3[df_year3$X1==1])*df_year3$n.patients[df_year3$X1==1])+
      ...
      satt_X2_A[j]=(sum((y1_posterior_year3[df_year3$X2=="A"]-y0_posterior_year3[df_year3$X2=="A"])*df_year3$n.patients[df_year3$X2=="A"])+
      ...
      satt_X2_B[j]=(sum((y1_posterior_year3[df_year3$X2=="B"]-y0_posterior_year3[df_year3$X2=="B"])*df_year3$n.patients[df_year3$X2=="B"])+
      ...
      satt_X2_C[j]=(sum((y1_posterior_year3[df_year3$X2=="C"]-y0_posterior_year3[df_year3$X2=="C"])*df_year3$n.patients[df_year3$X2=="C"])+
      ...
      satt_X3_0[j]=(sum((y1_posterior_year3[df_year3$X3==0]-y0_posterior_year3[df_year3$X3==0])*df_year3$n.patients[df_year3$X3==0])+
      ...
      satt_X3_1[j]=(sum((y1_posterior_year3[df_year3$X3==1]-y0_posterior_year3[df_year3$X3==1])*df_year3$n.patients[df_year3$X3==1])+
      ...
      satt_X4_A[j]=(sum((y1_posterior_year3[df_year3$X4=="A"]-y0_posterior_year3[df_year3$X4=="A"])*df_year3$n.patients[df_year3$X4=="A"])+
      ...
      satt_X4_B[j]=(sum((y1_posterior_year3[df_year3$X4=="B"]-y0_posterior_year3[df_year3$X4=="B"])*df_year3$n.patients[df_year3$X4=="B"])+
      ...
      satt_X4_C[j]=(sum((y1_posterior_year3[df_year3$X4=="C"]-y0_posterior_year3[df_year3$X4=="C"])*df_year3$n.patients[df_year3$X4=="C"])+
      ...
      satt_X5_0[j]=(sum((y1_posterior_year3[df_year3$X5==0]-y0_posterior_year3[df_year3$X5==0])*df_year3$n.patients[df_year3$X5==0])+
      ...
      satt_X5_1[j]=(sum((y1_posterior_year3[df_year3$X5==1]-y0_posterior_year3[df_year3$X5==1])*df_year3$n.patients[df_year3$X5==1])+
